...
<div class="row">
    <div class="col-md-12 text-center">
        ...
        <br>
        @else
        <button  type="button" class="btn btn-primary text-info m-2" >
            <a href="{{route('Blog.User.index.Route')}}" class="btn btn-success btn-lg btn-block">Mannage</a>  : UserPanel
         </button>
        @endif
    ...
    @foreach($posts as $post)
            <div class=" card m-3 ">
                ...
                <div class="post-body text-center alert-primary">
                    ...
                    <p class="text-center"><a href="{{ route('blog.post.id.Route', ['id' => $post->id]) }}" class="text-primary">Read more...</a></p>
                </div>
        </div>
    @endforeach
</div>
