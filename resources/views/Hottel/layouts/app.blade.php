      ...
      <div class="row">
        <div class="top-bar-left">
          <ul class="dropdown menu" data-dropdown-menu="tckp8q-dropdown-menu" role="menubar">
            <li role="menuitem"><a href="{{ route('main.index2.Route') }}">main</a></li>
            <li role="menuitem"><a href="{{ route('hotel_home.Route') }}">Home</a></li>
            <li role="menuitem"><a href="{{ route('hotel_clients.Route') }}">Clients</a></li>.
