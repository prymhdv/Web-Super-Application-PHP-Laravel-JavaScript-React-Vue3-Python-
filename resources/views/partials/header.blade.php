...
<!--Header ------------------------------------------------------------------------------------------------ -->
 <div class="Main_Header">
     <!-- ---------------------------------------------------------------------------------------------------- -->
     <div class="BoxUp">
         <a href="{{ route('main.index2') }}" class="bran_bt" style="font-size: 30px">فروشگاه مصالح و تجهیزات ساختمانی </a>
         <img src="{{asset('img/Logo/s.png')}}" alt="" class="site-Brand-Logo" width="50px" height="50px">
         <nav class="navbar1">
             <ul>
                 ...
                 <li><a href="{{route('VueJs')}}">Vue.JS</a></li>
                 <li><a href="{{route('ReactJs')}}">React.JS</a></li>
         ...
         <div class="Information">
             <i class="fa-sharp fa-solid fa-location-dot"> <a>آذربایجان شرقی - تبریز</a> </i>
             <i class="fa-brands fa-telegram"> <a>0914 555 44 88 </a></i>
     ...
     <div class="Authentication" style="display: inline-block; right:0; color:black;">
         <ul style="display: inline-block"><!-- Authentication Links -->
