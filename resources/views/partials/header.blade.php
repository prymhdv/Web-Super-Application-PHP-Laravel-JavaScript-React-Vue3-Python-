...
<div class= "d-flex flex-column min-vh-0" style="direction: rtl;">
    ...
    <div class="Main_Header">
        <!-- --------------------------------------------------------------sticky-top----fixed-top-----navbar-static-top--------------------  -->
        <nav id= "Main_HeaderNav" class=" navbar navbar-expand-lg navbar-dark bg-primary fixed-top p-0 m-0  mb-0">


            <button class=" navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarToggle">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse text-center flex-row" id="navbarToggle">
                <ul class="nav nav-list m-auto d-flex">
                    ...
                    <li class="nav-item"><a class="nav-link " href="{{ route('dev.ajax') }}">JS.ajax</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link " href="{{ route('DashboardOneUI_home.Route') }}">Dashboard</a></li>            
                    {{-- <li><a href="{!!   route('other.about')  !!}">About !! </a></li> --}}
                </ul>
            </div>

            <!-- ---------------------------------------------------------- -->
            <div class=" Authentication" style="display: inline-block; right:0; color:black;">
  ...
  <!-- Modal Form -->
    ...
    <script>
        ...
        $(window).on("resize", function() {
            ...
            document.getElementById("Main_HeaderNav").style.div;
            Height = document.querySelector(".Main_Header").offsetHeight + "px";
            console.log(Height);
            ...
            console.log(document.body);
            body = document.getElementsByTagName('body::before')[0];
            console.log("=============================");
            console.log(body);
            console.log(body);
            setRandomColor("#Main_HeaderNav")
            console.log(getRandomColor());
            console.log("-------------------------");
            //console.log(document.styleSheets[0]);
            let el = document.getElementsByTagName('body');
            //el.style.setProperty('--body-height', document.body.scrollHeight+'px');


        });
        //   $("#Main_HeaderNav").resize(function () {
        // $('#godown').height($("#Main_HeaderNav").height() + 10);
        // });

        // if ($("#Main_HeaderNav").height() > $('#godown').height()) $('#godown').height($("#Main_HeaderNav").height() + 10);
