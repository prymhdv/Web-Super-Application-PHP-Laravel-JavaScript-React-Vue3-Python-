    ...
    <div class="container gallery_bx">
                    ...
                    <div class="gallery"><?php
                     ...
                     // (C) OUTPUT IMAGES
                        ...
                        foreach (new DirectoryIterator($dirImage) as $fileInfo) { // interator
...
//                                printf("<img src='img/Slider/%s'>", $fileInfo->getFilename());
                                ...
                                printf("<figure><img src='img/Slider/%s'><figcaption>%s</figcaption></figure>",
                ...
                <div class="col-md-8">
                    <div class="col-md-6">
                        <div class="item">
                            ...
                            <P>زمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد
                                استفاده قرار گیرد.</P>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="item">
                            ...
                            <P>زمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا
            ...
            <div class="row row1">
                <div class="col-md-6">
                    <div class="desc">
                        ...
                        <div class="meta">
              <span>
                <i class="fa fa-calender-o">99.9.16</i>
                <i class="fa fa-comment-o">10 نظر</i>
              </span>
                        </div>
                        <p> با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی
                    ...
                    <div class="box">
                        ...
                        <div class="post-item-bx">
                            ...
                            <div class="col-md-7">
                                <div class="desc">
                                    <h5>شیرآلات</h5>
                                    <p>برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. </p>
                                    <span><i class="fa fa-calender-o">99.9.10</i></span>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="pic">
