    ...
    <div class="JStest">
            ...
            <h1 id="jsTitle" draggable="true">-------------------Java Script Basic
                ...
                <h1>
                    ...
                    <div style="margin:10px;">
                        <div id="TargetDiv" class="text-center" ondragover="allowDrop(event)" ondrop="drop(event)"
                            style="margin:auto;
                width:220px;
                height:60px;
                padding:10px;
                border:1px solid #999999"
                        ...
                        <img id="dragItem" src="{{ asset('img/aa.jpg') }}" width="200" height="50" draggable="true"
                    ...
                    <div class="ltr">
                        ...
                        <video id="video" controls width=320 height=240
                            poster="{{ asset('media/VolumeDataAlongSurfaceExample_01.png') }}"
                    ...
                    <div>
                        ...
                        <audio controls id="audio" onloadedmetadata="getAudioVolume()">
                            <source src="{{ asset('media/RockDrums-44p1-stereo-11secs.mp3') }}" type="audio/mpeg" />
                        ...
                        <br>
                        <img id="button" src="{{ asset('media/drawable-xhdpi/ic_menu_play_clip.png') }}"
                            onClick="PlayPause()" />
                    </div>
        ...
        <div class="content text-center">
            <h1 id="jsTitle" draggable="true">-------------------CSS Basic-------------------<h1>
                    ...
                    <img  src="{{ asset('media/drawable-xhdpi/ic_menu_play_clip.png') }}" />
                    <h1 class=" someH1 text-center"> SOME TEST</h1>


                    <div class="contetn2 text-center">
                        <p>
                            hello hello hello hello hello hello hello hello hello hello hello hello hello hello hello hello
                            hello hellohello hello hello hello hello hellohello hello hello hello hello hello
                            hello hello hello hello hello hello hello hello hello hello hello hello hello hello hello hello
                            hello hellohello hello hello hello hello hellohello hello hello hello hello hellohello hello
                            hello hello hello hello
                            hello hello hello hello hello hello hello hello hello hello hello hello hello hello hello hello
                            hello hellohello hello hello hello hello hellohello hello hello hello hello hello
                            hello hello hello hello hello hello hello hello hello hello hello hello hello hello hello hello
                            hello hellohello hello hello hello hello hello
                            hello hello hello hello hello hello hello hello hello hello hello hello hello hello hello hello
                            hello hellohello hello hello hello hello hello
                            hello hello hello hello hello hello hello hello hello hello hello hello hello hello hello hello
                            hello hellohello hello hello hello hello hello
                    ...
                    <h1 id="jsTitle" draggable="true">-------------------CSS Basic end -------------------<h1>
                            ...
                            <h1 id="jsTitle" draggable="true">-------------------Canvas Basic start -------------------
                                <h1>
                                    <canvas id="testCanvas" width="300px" height="300px">your browser cannot support canvas
                                        graphics </canvas>

                                    <h1 id="jsTitle" draggable="true">-------------------Canvas Basic 2-------------------
                                        <h1>

                                            <canvas id="test2Canvas" width="300px" height="300px">your browser cannot
                                                support canvas graphics.</canvas>


                                            <canvas id="test3Canvas" width="300px" height="300px">your browser cannot
                                                support canvas graphics.</canvas>


                                            <canvas id="test4Canvas" width="500px" height="300px">your browser cannot
                                                support canvas graphics.</canvas>

                                            <h1 id="jsTitle" draggable="true">-------------------Canvas Basic
                                                3-------------------<h1>
                                                    <canvas id="test5Canvas" width="300px" height="300px">your browser
                                                        cannot support canvas graphics.</canvas>

                                                    <h1 id="jsTitle" draggable="true">-------------------Canvas Basic 3
                                                        Pattern-------------------<h1>
                                                            <img id="pattern" src="{{ asset('media/star.png') }}" width="51"
                                                                height="50" style="display:none" />
                                                            <canvas id="test6Canvas" width="300px" height="300px">your
                                                                browser cannot support canvas graphics.</canvas>

                                                            <h1 id="jsTitle" draggable="true">-------------------Canvas
                                                                Basic 4 Pattern-------------------<h1>
                                                                    <a href="{{ route('main.index2.Route') }}">
                                                                        <canvas id="test7Canvas" width="300px"
                                                                            height="300px">your browser cannot support
                                                                            canvas graphics.</canvas>
                                                                    </a>
                                                                    <canvas id="test8Canvas" width="300px"
                                                                        height="300px"
                                                                        style="border: 1px solid black">your browser cannot
                                                                        support canvas graphics.</canvas>
                                                                                                    ...
                                                                                                    <h1 id="jsTitle"
                                                                                                        ...
                                                                                                        <h1>
                                                                                                            <div
                                                                                                                class="distance">
                                                                                                                <button
                                                                                                                    onClick="getDistance()">the
                                                                                                                    distance:
                                                                                                                    <span
                                                                                                                        id="distancer">xx</span></button>
                                                                                                                <script>
                                                                                                                            ...
                                                                                                                            <h1 id="jsTitle"
                                                                                                                                ...
                                                                                                                                <h1>
                                                                                                                                    <div
                                                                                                                                        ...
                                                                                                                                        <button
                                                                                                                                            id="press"
                                                                                                                                            onclick="listNames()">press</button>
                                                                                                                                        <div
                                                                                                                                            id="listofnames">
                                                                                                                                        </div>
                                                                                                                                    </div>
