...
Route::group(['prefix' => '', 'middleware' => ['AlwaysRedirect']], function () {
    ...
    Route::group(['prefix' => 'dev'], function () {
        ...
        Route::middleware(['auth'])->group(function () {
            ...
            //Route::get('/isAdmin', ['middleware' => ['IsAdmin', 'auth'],'AdminController@Heloo'])->name('Admin_MiddleWare');
            //Function () does not exist
        }); 
        Route::middleware(['auth'])->group(function () {
            Route::get('/isAdmin',  'AdminController@Hello')->name('Admin_MiddleWare');
        });
        Route::get('/admin', 'AdminController@index');
        Route::get('/middleware2', ['middleware' => ['IsAdmin', 'auth'], function () {
            return "Route::get hello midleware is here";
        }]); //Target class [IsAfdmin] does not exist.  IsAfdmin>IsAdmin  >>kernel define name
    });
