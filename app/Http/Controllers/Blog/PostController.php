...
class PostController extends Controller
{
    ...
    {
        $posts = Post::orderBy('created_at', 'desc')->paginate(4);//app/config/view.php
    ...
    {    // if(!Auth::check()){return redirect()->back();  }
        ...
        return redirect()->route('Blog.User.index.Route')->with('info', 'Post edited, new Title is: ' . $request->input('title'));
    }
