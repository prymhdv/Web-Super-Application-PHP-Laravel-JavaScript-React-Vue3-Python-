...
class ClientController extends Controller
{
    ...
    public function index()
    {
        ...
        //return redirect()->route('hotel_clients.Route');  //looped cant redirect ro self
    }
    ...
    public function export()
    {
        ...
        return route('hotel_export.Route', $data);
    ...
    public function newClient(Request $request, Client $client)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->route('hotel_clients.Route');
        }
    ...
    {   // dd($request['save']);
        ...
        if ($request->isMethod('post') && $request['save'] == 'SAVE') {   //return dd(redirect()->route('hotel_clients'));
            //dd($request);
            $this->validate(
                $request,
                [
            ...
            //return dd(redirect()->route('hotel_clients.Route'));
            $client_data = $this->client->find($client_id);
            ...
            return redirect()->route('hotel_clients.Route');
            //return redirect()->route('profile.Route', ['id' => 1]);
            // return to_route('profile.Route', ['id' => 1]);
            //return redirect()->route('profile.Route', [$user]);
...
/*
    -----------------------learning-----------
        ...
        // //dd($data);
        // //$uri = $request->path();
        // //return view(route('hotel_clients.Route').'/index', $data);
        // return redirect(route('the.named.route'));
        // return redirect()->route('the.named.route');
        // //return Route::view('hotel_clients.Route', 'hotel_clients.Route', $data);

        // //dd(Route::view(route('hotel_clients.Route').'/index', $data));
        // dd(route('hotel_clients.Route') .'/index', $data,1);
        // dd(view('hotel_clients.Route', $data));
        // return Route::view('hotel_clients', 'hotel_clients.Route', $data);


        //return Redirect::to('hotel_clients.Route', $data);
        //return redirect()->intended()->route('hotel_clients.Route', $data);
        //return view('Hottel/client/index', $data);
        //return redirect()->route('hotel_clients.Route', $data); error
        //return redirect()->route('hotel_clients.Route', compact($data) ); error
        ...
        // return view('hotel/client/form',$data);
         ...
         // dd(view('hotel_clients.Route', $data));
        // return view('hotel_clients.Route', $data);
        ...
        //return view('hotel_clients.Route', $data);
        //return redirect()->route('hotel_clients.Route', $data);
        //return view('Hottel/client/index', $data);
        //return redirect()->route('hotel_clients.Route', compact($data) );  error
