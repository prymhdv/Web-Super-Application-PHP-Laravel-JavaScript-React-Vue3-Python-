...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        $this->call([
            ...
            RoleSeeder::class,  //<<before UserTableSeeder
        ...
        $this->call([
            Blog\PostTableSeeder::class,
            Blog\TagTableSeeder::class,

        ]);
        $this->call([

            Hottel\ClientTableSeeder::class,
            Hottel\RoomTableSeeder::class,

        ]);
      
        // $this->call(Blog\PostTableSeeder::class);
        // $this->call(Blog\TagTableSeeder::class);
        // $this->call(Hottel\ClientTableSeeder::class);
        // $this->call(Hottel\RoomTableSeeder::class);
        ...
        DB::unprepared("
                        ...
                        VALUES
                        ( '2007-01-01', '2027-01-05', (SELECT id FROM clients LIMIT 1), (SELECT id FROM rooms LIMIT 1) )
                        ");
